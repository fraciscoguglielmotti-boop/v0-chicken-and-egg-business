...
async function main() {
  ...
  if (!existingSheets.includes("Usuarios")) {
    ...
    console.log("Usuarios sheet created with default admin/admin user.");
  } else {
    console.log("Usuarios sheet already exists, skipping.");
  }

  // Create "Configuracion" sheet
  if (!existingSheets.includes("Configuracion")) {
    ...
    console.log("Configuracion sheet created with login_activo = TRUE.");
  } else {
    console.log("Configuracion sheet already exists, skipping.");
  }
